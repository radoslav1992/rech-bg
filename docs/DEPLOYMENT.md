...
3. Добавете **Secret** `FAL_KEY` в Cloudflare Worker → Settings → Variables and Secrets. Този ключ обслужва Средно и Високо качество (Kling Standard/Pro). Не добавяйте `VITE_` префикс.
