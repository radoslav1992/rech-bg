...
Плановете и Stripe Price IDs запазват цените и числовите квоти. Съществуващите символи стават кредити 1:1 и вече изразходваното остава отчетено. Аудио: 1 символ = 1 кредит. Видео: **Ниско качество** — 200 кредита/сек. (InfiniteTalk Fast, `wavespeed-ai/infinitetalk-fast` през WaveSpeedAI); **Средно качество** — 600 кредита/сек. (`fal-ai/kling-video/ai-avatar/v2/standard`); **Високо качество** — 1 200 кредита/сек. (`fal-ai/kling-video/ai-avatar/v2/pro`). За 30 секунди: 6 000 / 18 000 / 36 000 кредита, допълнително към аудиото. Всяка започната секунда се брои за цяла. Подкасти с два гласа не са вход за един аватар.
