  ...
  privacy: {
    ...
    sections: [
      ...
      [
        ...
        "Използваме Cloudflare за хостинг, съхранение, обработка на аудио и служебни имейли и Stripe за плащания. За премиум озвучаване във Видео студио изпращаме сценария и избрания глас към ElevenLabs. За предложения за емоции обработваме сценария чрез AI услугата на Cloudflare. За субтитри на качено видео изпращаме видеото към ElevenLabs. Времената на думите се пазят със записа. Фоновият експорт се обработва в Cloudflare; локалният експорт се извършва във вашия браузър. При създаване на аватар с продукт изпращаме портрета и снимката на продукта към fal.ai и доставчика на услугата за изображения. При заявено видео изпращаме избрания аудиозапис и портрета към WaveSpeedAI при Ниско качество или към fal.ai при Средно и Високо качество, както и към съответния доставчик на видео услугата. Тези доставчици и техните подизпълнители могат да обработват данни извън ЕИП при приложимите договорни гаранции. Не продаваме личните ви данни. Не използваме проектите ви за собствено обучение на модели.",
      ],
      [
        "4. Срокове за съхранение",
        "Сценариите и настройките на до 100 проекта се пазят до изтриване или закриване на профила. След активиране на медийните инструменти записите и готовите експорти се пазят 7 дни при Проба, 30 дни при Начало, 90 дни при Създател и 180 дни при Студио. Точната дата е показана във Вашите файлове. Незапазените продуктови варианти се пазят 7 дни; изрично запазените изображения — при активен абонамент и 30 дни след края му. Незавършените качвания се почистват след 24 часа. Активната обработка временно отлага почистването. Старите записи получават пълен нов срок при първото включване в медийната библиотека. Мястото е 100 MB / 2 GB / 10 GB / 20 GB според плана, до 300 файла. При запълване новите операции се ограничават; не изтриваме автоматично запазени файлове, за да освободим място. Данните за заявките към доставчици се премахват след 30 дни; кратки записи за кредити и резултати остават за отчетност. Непотвърдените регистрации се премахват след 7 дни. Сесиите изтичат до 30 дни. Линковете за потвърждение важат 24 часа, а тези за възстановяване — 1 час. Запитванията се изтриват след 12 месеца. Необходимите счетоводни записи при платежния доставчик се пазят за законовите срокове. Резервни копия и ограничени технически логове могат да имат отделни срокове според доставчика.",
      ],
      [
        "5. Вашите права",
