      ...
      <section className="hero container">
        <div className="hero-copy">
          ...
          <div className="hero-proof">
            <span>
              <Check size={14} />1 000 безплатни символа
            </span>
            <span>
              <Check size={14} />
              Без банкова карта
        ...
        <div>
          {[
            [
              ...
              "Броим текста, който се озвучава, включително интервалите и пунктуацията. При подкаст етикетите на водещите не се таксуват. Преди всеки запис виждате точната стойност.",
            ],
            [
            ...
            [
              ...
              "При неуспешна генерация резервираните символи се връщат автоматично. Можете да опитате отново.",
            ],
            [
    ...
    <main className={inApp ? "app-page" : "container section pricing-page"}>
      ...
      <div className="pricing-notes">
        ...
        <p>
          ...
          плащане. Месечните символи не се прехвърлят. Безплатната проба изисква
          потвърден имейл.
        </p>
        <p>
...
> = {
  terms: {
    ...
    sections: [
      [
        "1. За услугата",
        "Реч БГ предоставя онлайн инструменти за преобразуване на текст в синтетична реч и за създаване на аудио разговори. Услугата е за лица на 18 или повече години. Регистрацията изисква валиден имейл, парола и приемане на настоящите условия.",
      ],
      [
        "2. Вашият профил",
      ...
      [
        "5. Цени и абонаменти",
        "Платените планове са месечни и се подновяват автоматично до прекратяване. Размерът, валутата и приложимите данъци се показват преди плащане. Символите се начисляват за озвучавания текст, включително интервалите и пунктуацията. Неизползваните месечни символи не се прехвърлят. Провалена генерация възстановява резервираните символи. Управлението на плащанията и фактурите е достъпно от профила.",
      ],
      [
        "6. Качество и достъпност",
        "Резултатите се генерират автоматично и може да съдържат грешки в произношението, ударението или интонацията. Преслушвайте ги преди публикуване. Не обещаваме непрекъсната достъпност или конкретно време за генериране. Това не ограничава законовите ви потребителски права.",
      ],
      [
  ...
  privacy: {
    ...
    sections: [
      [
        ...
        "Име и имейл, защитен хеш на паролата, текстове на проекти, генерирани записи, данни за използваните символи, идентификатори за абонамента и кореспонденция с поддръжката. За защита от злоупотреби пазим ограничени технически записи и краткотрайни хеширани идентификатори. Не съхраняваме пълни данни за банкови карти.",
      ],
      [
        "2. Защо ги използваме",
        "Изпълнение на договора: профил, аудио генерация, съхранение и плащания. Законово задължение: счетоводни и данъчни документи, когато е приложимо. Легитимен интерес: сигурност, предотвратяване на злоупотреби и отговор на запитвания. Не изпращаме маркетингови писма без отделно основание.",
      ],
      [
        "3. Доставчици и получатели",
        "Използваме Cloudflare за хостинг, съхранение и обработка на аудио, Stripe за плащания и Resend за служебни имейли. Тези доставчици и техните подизпълнители могат да обработват данни извън ЕИП при приложимите договорни гаранции. Не продаваме личните ви данни. Не използваме проектите ви за собствено обучение на модели.",
      ],
      [
  ...
  refunds: {
    ...
    sections: [
      ...
      [
        "Начало на услугата",
        "Активирането на услугата и използването на символи сами по себе си не премахват законовото право на отказ. Настоящият процес не изисква отказ от това право. Исканията се разглеждат съобразно приложимите правила за услуги и цифрово съдържание.",
      ],
      [
        "Проблем с генерацията",
        "При неуспешен запис резервираните символи се връщат автоматично. Ако записът е повреден или възстановяването не се е отразило, изпратете името на проекта през контактната форма.",
      ],
      [
