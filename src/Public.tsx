        ...
        <div>
          {[
            [
              ...
              "1 символ озвучен текст = 1 кредит, включително интервалите и пунктуацията. При подкаст етикетите на водещите не се таксуват. Видео използва 200 кредита на секунда за Ниско качество, 600 за Средно и 1 200 за Високо. Цената се показва преди генериране.",
            ],
            [
  ...
  return (
    <main className={inApp ? "app-page" : "container section pricing-page"}>
      ...
      <div className="pricing-notes">
        <p><strong>Един баланс за аудио и видео.</strong> 1 символ текст = 1 кредит. Видео: Ниско качество — 200 кредита/сек.; Средно — 600; Високо — 1 200. Видеото използва готов запис с един глас от 5 до 60 секунди. Всяка започната секунда се закръгля нагоре; аудиото се таксува отделно.</p>
        <p>
          <ShieldCheck size={18} />
...
> = {
  terms: {
    ...
    sections: [
      ...
      [
        "5. Цени и абонаменти",
        "Платените планове са месечни и се подновяват автоматично до прекратяване. Размерът, валутата и приложимите данъци се показват преди плащане. Кредитите са общ баланс за аудио и видео: 1 символ озвучен текст = 1 кредит. Видео струва 200 кредита за започната секунда за Ниско качество, 600 за Средно и 1 200 за Високо. Цената за видео е допълнителна към вече създаденото аудио и се потвърждава преди заявката. Неуспешно видео връща само кредитите за видеото. Неизползваните месечни кредити не се прехвърлят. Провалена генерация възстановява резервираните кредити. Управлението на плащанията и фактурите е достъпно от профила.",
      ],
      [
