        ...
        <div>
          {[
            [
              ...
              "1 символ озвучен текст = 1 кредит, включително интервалите и пунктуацията. При подкаст етикетите на водещите не се таксуват. Видео Стандартно използва 300 кредита на секунда, а Високо качество — 1 200. Цената се показва преди генериране.",
            ],
            [
  ...
  return (
    <main className={inApp ? "app-page" : "container section pricing-page"}>
      ...
      <div className="pricing-notes">
        <p><strong>Един баланс за аудио и видео.</strong> 1 символ текст = 1 кредит. Видео: Стандартно — 300 кредита/сек.; Високо качество — 1 200 кредита/сек. Видеото използва готов запис с един глас от 5 до 60 секунди. Всяка започната секунда се закръгля нагоре; аудиото се таксува отделно.</p>
        <p>
          <ShieldCheck size={18} />
...
> = {
  terms: {
    ...
    sections: [
      ...
      [
        "5. Цени и абонаменти",
        "Платените планове са месечни и се подновяват автоматично до прекратяване. Размерът, валутата и приложимите данъци се показват преди плащане. Кредитите са общ баланс за аудио и видео: 1 символ озвучен текст = 1 кредит. Видео Стандартно струва 300 кредита за започната секунда, а Високо качество — 1 200. Цената за видео е допълнителна към вече създаденото аудио и се потвърждава преди заявката. Неуспешно видео връща само кредитите за видеото. Неизползваните месечни кредити не се прехвърлят. Провалена генерация възстановява резервираните кредити. Управлението на плащанията и фактурите е достъпно от профила.",
      ],
      [
  ...
  privacy: {
    ...
    sections: [
      ...
      [
        ...
        "Използваме Cloudflare за хостинг, съхранение, обработка на аудио и служебни имейли и Stripe за плащания. При заявено видео изпращаме избрания аудиозапис и, ако е приложимо, портрета към fal.ai и съответния му доставчик на видео услугата. Тези доставчици и техните подизпълнители могат да обработват данни извън ЕИП при приложимите договорни гаранции. Не продаваме личните ви данни. Не използваме проектите ви за собствено обучение на модели.",
      ],
      [
